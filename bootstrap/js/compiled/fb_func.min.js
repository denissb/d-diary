...
'</a><a class="btn btn-mini disabled" id="bd_after" href="javascript:void(0)">'+ui_lang.upcoming+"</a></div>");a("div#friends_birthdays").children(".well").first().addDiv("","","result_birthdays");a("div#friends_birthdays").children(".well").append('<div class="plugin_buttons bottom"><a class="btn btn-mini" id="bd_less" href="javascript:void(0)"><i class="icon-chevron-up"></i></a><a class="btn btn-mini" id="bd_more" href="javascript:void(0)">'+ui_lang.show_more+'</a></div><div class="clearfix"></div>')},
getOrderedBirthdays:function(b,e){var c=a.totalStorage("friends_data"),g=b?b:new Date;g.setHours(0,0,0,0);var h=[],k=[];for(i in c)void 0!=c[i].birthday&&(b=f(c[i].birthday,g),c[i].birthday_date=b,"after"==e?b>=g?(b.getTime()==g.getTime()&&(c[i].has_bd=!0),h.push(c[i])):k.push(c[i]):b<g?(b.getTime()==g.getTime()&&(c[i].has_bd=!0),h.push(c[i])):k.push(c[i]));c="after"==e?function(a,g){return a.birthday_date-g.birthday_date}:function(a,g){return g.birthday_date-a.birthday_date};h=h.sort(c);k=k.sort(c);
d=h=h.concat(k)},displayBirthdays:function(b){b=d.splice(0,b);var e="",c="",g;for(g in b)b[g].hasOwnProperty("has_bd")?(e+="<div class='birthday is_today'>",c="<i class='icon-gift'></i>"):(e+="<div class='birthday'>",c=""),e+="<div class='img_holder'><a href='https://facebook.com/"+b[g].id+"' title='"+b[g].name+"' target='_blank'><img src='"+b[g].picture.data.url+"'/></a></div>",e+="<span class='name'>"+b[g].name+c+"</span>",e+="<span class='date'>"+b[g].birthday_date.getMonthName()+" "+b[g].birthday_date.getDate()+
"</span>",e+="</div>";a("div#result_birthdays").append(e)},addEventHandlers:function(){a("div.cal-cell").click(function(){a("div#result_birthdays").empty();Plugins.FriendsBirthdays.getOrderedBirthdays(getSelDate(),"after");Plugins.FriendsBirthdays.displayBirthdays(3);a("#bd_after").addClass("disabled");a("#bd_before").removeClass("disabled")});a("#bd_more").on("click",function(){Plugins.FriendsBirthdays.displayBirthdays(3);a("#bd_less").show()});a("#bd_less").on("click",function(){a("#bd_after").trigger("click");
a(this).hide()});a("#bd_after").on("click",function(){a("div#result_birthdays").empty();Plugins.FriendsBirthdays.getOrderedBirthdays(getSelDate(),"after");Plugins.FriendsBirthdays.displayBirthdays(3);a(this).addClass("disabled");a("#bd_before").removeClass("disabled")});a("#bd_before").on("click",function(){a("div#result_birthdays").empty();Plugins.FriendsBirthdays.getOrderedBirthdays(getSelDate(),"before");Plugins.FriendsBirthdays.displayBirthdays(3);a(this).addClass("disabled");a("#bd_after").removeClass("disabled")})}}}(jQuery);
...
ui_lang.past+'</a><a class="btn btn-mini disabled" id="evt_after" href="javascript:void(0)">'+ui_lang.upcoming+"</a></div>");a("div#friends_events").children(".well").first().addDiv("","","result_events");a("div#friends_events").children(".well").append('<div class="plugin_buttons bottom"><a class="btn btn-mini" id="evt_less" href="javascript:void(0)"><i class="icon-chevron-up"></i></a><a class="btn btn-mini" id="evt_more" href="javascript:void(0)">'+ui_lang.show_more+'</a></div><div class="clearfix"></div>')},
getOrderedEvents:function(b,d){c=a.totalStorage("events_data");var f=b?b:new Date;f.setHours(0,0,0,0);var l=[],n=0;for(i in c){if(500<n)break;else n++;var m=new Date(c[i].start_time);"after"==d?m>=f&&(m.setHours(0,0,0,0)==f.getTime()&&(c[i].is_today=!0),l.push(c[i])):m<f&&(m.setHours(0,0,0,0)==f.getTime()&&(c[i].is_today=!0),l.push(c[i]))}e=l="after"==d?l.sort(function(a,b){return new Date(a.start_time)-new Date(b.start_time)}):l.sort(function(a,b){return new Date(b.start_time)-new Date(a.start_time)})},
displayEvents:function(a){a=e.splice(0,a);d(a)},addEventHandlers:function(){a("div.cal-cell").click(function(){a("div#result_events").empty();Plugins.FriendsEvents.getOrderedEvents(getSelDate(),"after");Plugins.FriendsEvents.displayEvents(3);a("#evt_after").addClass("disabled");a("#evt_before").removeClass("disabled")});a("#evt_more").on("click",function(){Plugins.FriendsEvents.displayEvents(3);a("#evt_less").show()});a("#evt_less").on("click",function(){a("#evt_after").trigger("click");a(this).hide()});
a("#evt_after").on("click",function(){a("div#result_events").empty();Plugins.FriendsEvents.getOrderedEvents(getSelDate(),"after");Plugins.FriendsEvents.displayEvents(3);a(this).addClass("disabled");a("#evt_before").removeClass("disabled")});a("#evt_before").on("click",function(){a("div#result_events").empty();Plugins.FriendsEvents.getOrderedEvents(getSelDate(),"before");Plugins.FriendsEvents.displayEvents(3);a(this).addClass("disabled");a("#evt_after").removeClass("disabled")});a("#evt_search").live("click",
function(b){b.preventDefault();a(this).popover("toggle");a("#evt_search_field").focus()});a("#evt_search").popover({trigger:"manual",html:!0,content:function(){return'<div class="arrow"></div><div class="popover-inner small"><div class="popover-add"><div class="input-append"><input class="span2" id="evt_search_field" type="text"><button class="btn" id="evt_find" type="button">'+ui_lang.find+"</button></div></div></div>"},placement:"bottom"});a("#evt_find").live("click",function(){b();a("#evt_search").popover("hide")});
a("#evt_search_field").live("keypress",function(c){13==c.which&&(b(),a("#evt_search").popover("hide"))})}}}(jQuery);
