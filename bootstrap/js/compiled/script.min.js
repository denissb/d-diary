...
!function(a){var c=function(b){a(b).on("click",'[data-dismiss="alert"]',this.close)};c.prototype.close=function(b){function d(){g.trigger("closed").remove()}var c=a(this),f=c.attr("data-target"),g;f||(f=(f=c.attr("href"))&&f.replace(/.*(?=#[^\s]*$)/,""));g=a(f);b&&b.preventDefault();g.length||(g=c.hasClass("alert")?c:c.parent());g.trigger(b=a.Event("close"));b.isDefaultPrevented()||(g.removeClass("in"),a.support.transition&&g.hasClass("fade")?g.on(a.support.transition.end,d):d())};a.fn.alert=function(b){return this.each(function(){var d=
...
b&&b.find(".active").removeClass("active");this.$element.toggleClass("active")};a.fn.button=function(b){return this.each(function(){var d=a(this),e=d.data("button"),f="object"==typeof b&&b;e||d.data("button",e=new c(this,f));"toggle"==b?e.toggle():b&&e.setState(b)})};a.fn.button.defaults={loadingText:"loading..."};a.fn.button.Constructor=c;a(function(){a("body").on("click.button.data-api","[data-toggle^=button]",function(b){b=a(b.target);b.hasClass("btn")||(b=b.closest(".btn"));b.button("toggle")})})}(window.jQuery);
...
!1}};a.fn.dropdown=function(b){return this.each(function(){var c=a(this),g=c.data("dropdown");g||c.data("dropdown",g=new d(this));"string"==typeof b&&g[b].call(c)})};a.fn.dropdown.Constructor=d;a(function(){a("html").on("click.dropdown.data-api",c);a("body").on("click.dropdown",".dropdown form",function(b){b.stopPropagation()}).on("click.dropdown.data-api",b,d.prototype.toggle)})}(window.jQuery);
!function(a){function c(){var d=this,c=setTimeout(function(){d.$element.off(a.support.transition.end);b.call(d)},500);this.$element.one(a.support.transition.end,function(){clearTimeout(c);b.call(d)})}function b(b){this.$element.hide().trigger("hidden");d.call(this)}function d(b){var d=this.$element.hasClass("fade")?"fade":"";if(this.isShown&&this.options.backdrop){var c=a.support.transition&&d;this.$backdrop=a('<div class="modal-backdrop '+d+'" />').appendTo(document.body);"static"!=this.options.backdrop&&
this.$backdrop.click(a.proxy(this.hide,this));c&&this.$backdrop[0].offsetWidth;this.$backdrop.addClass("in");c?this.$backdrop.one(a.support.transition.end,b):b()}else!this.isShown&&this.$backdrop?(this.$backdrop.removeClass("in"),a.support.transition&&this.$element.hasClass("fade")?this.$backdrop.one(a.support.transition.end,a.proxy(e,this)):e.call(this)):b&&b()}function e(){this.$backdrop.remove();this.$backdrop=null}function f(){var b=this;if(this.isShown&&this.options.keyboard)a(document).on("keyup.dismiss.modal",
function(a){27==a.which&&b.hide()});else this.isShown||a(document).off("keyup.dismiss.modal")}var g=function(b,d){this.options=d;this.$element=a(b).delegate('[data-dismiss="modal"]',"click.dismiss.modal",a.proxy(this.hide,this))};g.prototype={constructor:g,toggle:function(){return this[this.isShown?"hide":"show"]()},show:function(){var b=this,c=a.Event("show");this.$element.trigger(c);this.isShown||c.isDefaultPrevented()||(a("body").addClass("modal-open"),this.isShown=!0,f.call(this),d.call(this,
...
leave:function(b){var d=a(b.currentTarget)[this.type](this._options).data(this.type);this.timeout&&clearTimeout(this.timeout);if(!d.options.delay||!d.options.delay.hide)return d.hide();d.hoverState="out";this.timeout=setTimeout(function(){"out"==d.hoverState&&d.hide()},d.options.delay.hide)},show:function(){var b,a,c,f,g,h,k;if(this.hasContent()&&this.enabled){b=this.tip();this.setContent();this.options.animation&&b.addClass("fade");h="function"==typeof this.options.placement?this.options.placement.call(this,
...
a.content)},tip:function(){this.$tip||(this.$tip=a(this.options.template));return this.$tip}});a.fn.popover=function(b){return this.each(function(){var d=a(this),e=d.data("popover"),f="object"==typeof b&&b;e||d.data("popover",e=new c(this,f));if("string"==typeof b)e[b]()})};a.fn.popover.Constructor=c;a.fn.popover.defaults=a.extend({},a.fn.tooltip.defaults,{placement:"right",content:"",template:'<div class="popover"><div class="popover-container"></div></div>'})}(window.jQuery);
!function(a){var c=function(b){this.element=a(b)};c.prototype={constructor:c,show:function(){var b=this.element,c=b.closest("ul:not(.dropdown-menu)"),e=b.attr("data-target"),f,g;e||(e=(e=b.attr("href"))&&e.replace(/.*(?=#[^\s]*$)/,""));b.parent("li").hasClass("active")||(f=c.find(".active a").last()[0],g=a.Event("show",{relatedTarget:f}),b.trigger(g),g.isDefaultPrevented()||(e=a(e),this.activate(b.parent("li"),c),this.activate(e,e.parent(),function(){b.trigger({type:"shown",relatedTarget:f})})))},
activate:function(b,c,e){function f(){g.removeClass("active").find("> .dropdown-menu > .active").removeClass("active");b.addClass("active");h?(b[0].offsetWidth,b.addClass("in")):b.removeClass("fade");b.parent(".dropdown-menu")&&b.closest("li.dropdown").addClass("active");e&&e()}var g=c.find("> .active"),h=e&&a.support.transition&&g.hasClass("fade");h?g.one(a.support.transition.end,f):f();g.removeClass("in")}};a.fn.tab=function(b){return this.each(function(){var d=a(this),e=d.data("tab");e||d.data("tab",
...
a(b.currentTarget).addClass("active")}};a.fn.typeahead=function(b){return this.each(function(){var d=a(this),e=d.data("typeahead"),f="object"==typeof b&&b;e||d.data("typeahead",e=new c(this,f));if("string"==typeof b)e[b]()})};a.fn.typeahead.defaults={source:[],items:8,menu:'<ul class="typeahead dropdown-menu"></ul>',item:'<li><a href="#"></a></li>'};a.fn.typeahead.Constructor=c;a(function(){a("body").on("focus.typeahead.data-api",'[data-provide="typeahead"]',function(b){var c=a(this);c.data("typeahead")||
(b.preventDefault(),c.typeahead(c.data()))})})}(window.jQuery);
!function(a){var c=function(b,c){this.$element=a(b);this.options=a.extend({},a.fn.collapse.defaults,c);this.options.parent&&(this.$parent=a(this.options.parent));this.options.toggle&&this.toggle()};c.prototype={constructor:c,dimension:function(){return this.$element.hasClass("width")?"width":"height"},show:function(){var b,c,e,f;if(!this.transitioning){b=this.dimension();c=a.camelCase(["scroll",b].join("-"));if((e=this.$parent&&this.$parent.find("> .accordion-group > .in"))&&e.length){if((f=e.data("collapse"))&&
f.transitioning)return;e.collapse("hide");f||e.data("collapse",null)}this.$element[b](0);this.transition("addClass",a.Event("show"),"shown");a.support.transition&&this.$element[b](this.$element[0][c])}},hide:function(){var b;this.transitioning||(b=this.dimension(),this.reset(this.$element[b]()),this.transition("removeClass",a.Event("hide"),"hidden"),this.$element[b](0))},reset:function(b){var a=this.dimension();this.$element.removeClass("collapse")[a](b||"auto")[0].offsetWidth;this.$element[null!==
b?"addClass":"removeClass"]("collapse");return this},transition:function(b,c,e){var f=this,g=function(){"show"==c.type&&f.reset();f.transitioning=0;f.$element.trigger(e)};this.$element.trigger(c);c.isDefaultPrevented()||(this.transitioning=1,this.$element[b]("in"),a.support.transition&&this.$element.hasClass("collapse")?this.$element.one(a.support.transition.end,g):g())},toggle:function(){this[this.$element.hasClass("in")?"hide":"show"]()}};a.fn.collapse=function(b){return this.each(function(){var d=
a(this),e=d.data("collapse"),f="object"==typeof b&&b;e||d.data("collapse",e=new c(this,f));if("string"==typeof b)e[b]()})};a.fn.collapse.defaults={toggle:!0};a.fn.collapse.Constructor=c;a(function(){a("body").on("click.collapse.data-api","[data-toggle=collapse]",function(b){var c=a(this),e;b=c.attr("data-target")||b.preventDefault()||(e=c.attr("href"))&&e.replace(/.*(?=#[^\s]+$)/,"");e=a(b).data("collapse")?"toggle":c.data();c[a(b).hasClass("in")?"addClass":"removeClass"]("collapsed");a(b).collapse(e)})})}(window.jQuery);
!function(a){var c=function(b){this.element=a(b)};c.prototype={constructor:c,show:function(){var b=this.element,c=b.closest("ul:not(.dropdown-menu)"),e=b.attr("data-target"),f,g;e||(e=(e=b.attr("href"))&&e.replace(/.*(?=#[^\s]*$)/,""));b.parent("li").hasClass("active")||(f=c.find(".active:last a")[0],g=a.Event("show",{relatedTarget:f}),b.trigger(g),g.isDefaultPrevented()||(e=a(e),this.activate(b.parent("li"),c),this.activate(e,e.parent(),function(){b.trigger({type:"shown",relatedTarget:f})})))},activate:function(b,
c,e){function f(){g.removeClass("active").find("> .dropdown-menu > .active").removeClass("active");b.addClass("active");h?(b[0].offsetWidth,b.addClass("in")):b.removeClass("fade");b.parent(".dropdown-menu")&&b.closest("li.dropdown").addClass("active");e&&e()}var g=c.find("> .active"),h=e&&a.support.transition&&g.hasClass("fade");h?g.one(a.support.transition.end,f):f();g.removeClass("in")}};a.fn.tab=function(b){return this.each(function(){var d=a(this),e=d.data("tab");e||d.data("tab",e=new c(this));
if("string"==typeof b)e[b]()})};a.fn.tab.Constructor=c;a(document).on("click.tab.data-api",'[data-toggle="tab"], [data-toggle="pill"]',function(b){b.preventDefault();a(this).tab("show")})}(window.jQuery);(function(a,c,b){function d(b){return b}function e(b){return decodeURIComponent(b.replace(f," "))}var f=/\+/g,g=a.cookie=function(f,k,n){if(k!==b){n=a.extend({},g.defaults,n);null===k&&(n.expires=-1);if("number"===typeof n.expires){var s=n.expires,w=n.expires=new Date;w.setDate(w.getDate()+s)}k=g.json?JSON.stringify(k):String(k);return c.cookie=[encodeURIComponent(f),"=",g.raw?k:encodeURIComponent(k),n.expires?"; expires="+n.expires.toUTCString():"",n.path?"; path="+n.path:"",n.domain?"; domain="+
n.domain:"",n.secure?"; secure":""].join("")}k=g.raw?d:e;n=c.cookie.split("; ");s=0;for(w=n.length;s<w;s++){var x=n[s].split("=");if(k(x.shift())===f)return f=k(x.join("=")),g.json?JSON.parse(f):f}return null};g.defaults={};a.removeCookie=function(b,c){return null!==a.cookie(b)?(a.cookie(b,null,c),!0):!1}})(jQuery,document);(function(a){var c=window.localStorage,b;b="undefined"==typeof c||"undefined"==typeof window.JSON?!1:!0;a.totalStorage=function(b,c){return a.totalStorage.impl.init(b,c)};a.totalStorage.setItem=function(b,c){return a.totalStorage.impl.setItem(b,c)};a.totalStorage.getItem=function(b){return a.totalStorage.impl.getItem(b)};a.totalStorage.getAll=function(){return a.totalStorage.impl.getAll()};a.totalStorage.deleteItem=function(b){return a.totalStorage.impl.deleteItem(b)};a.totalStorage.impl={init:function(b,
a){return"undefined"!=typeof a?this.setItem(b,a):this.getItem(b)},setItem:function(d,e){if(!b)try{return a.cookie(d,e),e}catch(f){console.log("Local Storage not supported by this browser. Install the cookie plugin on your site to take advantage of the same functionality. You can get it at https://github.com/carhartl/jquery-cookie")}var g=JSON.stringify(e);c.setItem(d,g);return this.parseResult(g)},getItem:function(d){if(!b)try{return this.parseResult(a.cookie(d))}catch(e){return null}return this.parseResult(c.getItem(d))},
deleteItem:function(d){if(!b)try{return a.cookie(d,null),!0}catch(e){return!1}c.removeItem(d);return!0},getAll:function(){var d=[];if(b)for(f in c)f.length&&d.push({key:f,value:this.parseResult(c.getItem(f))});else try{for(var e=document.cookie.split(";"),f=0;f<e.length;f++){var g=e[f].split("=")[0];d.push({key:g,value:this.parseResult(a.cookie(g))})}}catch(h){return null}return d},parseResult:function(b){var a;try{a=JSON.parse(b),"true"==a&&(a=!0),"false"==a&&(a=!1),parseFloat(a)==a&&"object"!=typeof a&&
...
""===f?h.push(this.el.bind(a,g)):h.push(this.el.delegate(f,a,g));return h};return c}()}).call(this);(function(a){function c(a,c){for(var d=0,e=a.length;d<e;d++)if(a[d]==c)return!b;return b}var b=!1,d=parseFloat,e=String.fromCharCode,f=Math.min,g=/(-?\d+\.?\d*)$/g,h,k=[],n,s,w=9472,x={},H;Array.indexOf||(Array.prototype.indexOf=function(b){for(var a=0,c=this.length;a<c;a++)if(this[a]==b)return a;return-1});for(var y=32,A=e(y);255>y;y++,A=e(y).toLowerCase())-1!==k.indexOf(A)&&k.push(A);k.sort();a.tinysort={id:"TinySort",version:"1.3.27",copyright:"Copyright (c) 2008-2012 Ron Valstar",uri:"http://tinysort.sjeiti.com/",
...
1).match(/[^}]*/)[0],B(l,e(w++)),m+=l.length+1,s=!0):u.push(F);u.length&&(C||m===J-1)&&(l=u.join(""),v+=l,a.each(l,function(b,a){n.splice(n.indexOf(a),1)}),l=u.slice(0),l.splice(0,0,n.indexOf(z)+1,0),Array.prototype.splice.apply(n,l),u.length=0);m+1===J?H=RegExp("["+v+"]","gi"):C&&(z=F)}}else s=!1,w=9472,x={},H=n=null;r||(r="rand"==p.order?function(){return 0.5>Math.random()?1:-1}:function(a,c){var e=b,h=p.cases?a.s:a.s&&a.s.toLowerCase?a.s.toLowerCase():a.s,k=p.cases?c.s:c.s&&c.s.toLowerCase?c.s.toLowerCase():
c.s;if(!p.forceStrings){var l=h&&h.match(g),m=k&&k.match(g);if(l&&m){var r=h.substr(0,h.length-l[0].length),t=k.substr(0,k.length-m[0].length);r==t&&(e=!b,h=d(l[0]),k=d(m[0]))}}l=O*(h<k?-1:h>k?1:0);if(!e&&p.charOrder){if(s)for(var q in x)e=x[q],h=h.replace(q,e),k=k.replace(q,e);if(null!==h.match(H)||null!==k.match(H))for(q=0,e=f(h.length,k.length);q<e&&!(l=n.indexOf(h[q]),m=n.indexOf(k[q]),l=O*(l<m?-1:l>m?1:0));q++);}return l});this.each(function(b,c){var d=a(c),e=M?N?U.filter(c):d.find(t):d,f=T?
...
$(".popover-content .details").toggle();0==$("div.wysiwyg").length&&(a=new Wysiwyg,$(".area").before(a.el));$(this).children("i").toggleClass("icon-chevron-down");$(this).children("i").toggleClass("icon-chevron-up")});$("#add-event").live("click",function(a){a.preventDefault();a=$("div.cal-active").find(".day").html();var b=$("input.time_p").val(),d=$("input.event_p").val(),e=$("div.area").text();""!=a&""!=d?$.ajax({type:"POST",url:config.add_event,dataType:"json",data:{day:a,time:b,event:d,description:e},
success:function(a){"Added"==a.result?(change_count("+"),$(".popover-add").response(ui_lang.cal_added,!0),$("p.event-info").remove(),add_event(a.id,b,d,e),$("div#event-conteiner > div").tsort("span.time"),$(".close-popover").trigger("click")):$(".popover-add").response(a.result,!1)},fail:function(){$(".popover-add").response(ui_lang.server_side_error,!1)}}):$(".popover-add").response(ui_lang.cal_no_values,!1)});$("button.show-desc").live("click",function(){$(this).parent(".description").toggleClass("closed");
...
desc_button()});$(document).on("hover",".change-event",function(){$(this).datepicker("show");$(document).on("hover",".delete-event",function(){$(".change-event").datepicker("hide")});$(document).on("hover",".done-event",function(){$(".change-event").datepicker("hide")});$(this).datepicker().on("changeDate",function(a){var b=$(this).parents(":eq(4)"),d=b.find("button.edit-event").attr("id"),e=getFormatedDate(a.date);if(void 0!=d){if(a.date.getTime()==getSelDate().getTime())return!1;$.ajax({type:"POST",
url:config.changedate,data:{id:d,newdate:e},success:function(d){"changed"==d?(b.parent().response(ui_lang.cal_date_changed+e,!0),change_count("-"),a.date.getMonth()==getSelDate().getMonth()&&find_increment(a.date.getDate()),b.remove()):b.response(ui_lang.cal_error_change,!1)},fail:function(){alert(ui_lang.fail)}})}else alert(ui_lang.finish_editing);$(this).datepicker("hide");a.stopPropogation()})});$("#show-add").live("click",function(){$("#event-container").hide();$(".calendar .cal-cell").popover("hide");
$("#add-section").fadeIn("fast");if(0==$("div.wysiwyg").length){var a=new Wysiwyg;$(".area").before(a.el)}$(this).hide();ready_time($("input#time"))});$("#hide-add").live("click",function(a){a.preventDefault();$("div.wysiwyg").remove();$("#add-section").hide();$("#show-add").fadeIn("fast");$("#event-container").fadeIn("fast")});$("#main-add").live("click",function(a){a.preventDefault();a=$("h2#active-date").html().slice(0,-1);var b=$("#time").val(),d=$("#event").val(),e=$("div.area")[0].innerHTML;
""!=a&""!=d?$.ajax({type:"POST",url:config.add_event,dataType:"json",data:{day:a,time:b,event:d,description:e},success:function(a){"Added"==a.result?(change_count("+"),add_event(a.id,b,d,e),$("p.event-info").remove(),$("div#event-container > div").tsort("span.time"),$("#hide-add").trigger("click"),$("div#event-container").response(ui_lang.cal_added,!0)):$(".popover-add").response(a.result,!1)},fail:function(){$(".popover-add").response(ui_lang.server_side_error,!1)}}):$(".popover-add").response(ui_lang.no_values,
