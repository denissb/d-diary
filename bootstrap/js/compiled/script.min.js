...
!1)},fail:function(){alert(ui_lang.fail)}})}else alert(ui_lang.finish_editing);$(this).datepicker("hide");b.stopPropogation()})});$(document).on("click",".show-small-cal",function(){$(this).datepicker("show")});$("#show-add").live("click",function(){$("#event-container").hide();$(".calendar .cal-cell").popover("hide");$("#add-section").fadeIn("fast");if(0==$("div.wysiwyg").length){var b=new Wysiwyg;$(".area").before(b.el)}$(this).hide();ready_time($("input#time"))});$("#hide-add").live("click",function(b){b.preventDefault();
