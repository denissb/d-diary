		...
		<button class="btn toggle-cal"><i class="icon-chevron-up"></i></button>
		<button class="btn show-small-cal" data-date-format="yyyy-mm-dd" 
		data-date="{calendar-date}"><i class="icon-calendar"></i></button>
		</th>
		{/heading_title_cell}
