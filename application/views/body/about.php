<div class="container-fluid">
    ...
    <div class="row-fluid">
        <div class="span4 slogan">
            <h2 class="shadow">D-diary is a simple way to organise your day!</h2>
            <ul class="features">
                <li>Simple and elegant design</li>
                <li>Easy to use</li>
                <li>Extendable with aditional features</li>
                <li>Not bloated with things you don't want</li>
                <li>The vintage look and feel of a simple wall calendar</li>
            </ul>
        </div><!--/span-->
